...
Um eine Fehlerabschätzung für die mehrdimensionale Quadratur zu erhalten, geht man
eben so wie bei dem Verfahren mit Hilfe von Fubini vor.

Hat man nun eine $d$ dimensionale Funktion, mit eindimensionalen Quadraturen, die jeweils $n_d$ Stützstellen haben, so
...
der Intervalllänge, der Anzahl der Stützstellen, und höheren Ableitungen der Funktion abhängt. 
